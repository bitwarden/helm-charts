...
{{/*
Name of Portal components
*/}}
{{- define "bitwarden.portal" -}}
{{ template "bitwarden.fullname" . }}-portal
{{- end -}}

{{/*
Name of Proxy components
*/}}
{{- define "bitwarden.proxy" -}}
{{ template "bitwarden.fullname" . }}-proxy
{{- end -}}
